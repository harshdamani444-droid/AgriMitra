  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${API_URL}/predict/mango-prediction`,
        formData,
        {
          headers: {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow m-10">
      <h2 className="text-2xl font-bold mb-6 flex items-center gap-2 text-green-600 text-center">
        <ImageIcon />
        <h2 className="text-center">Mango Disease Detection</h2>
      </h2>
      <p className="text-gray-600 mb-4">
        Upload an image of a mango leaf to detect common diseases.
      </p>
      <p className="text-gray-600 mb-4">
...
export default MangoPrediction;
